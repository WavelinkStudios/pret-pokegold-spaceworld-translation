...
LassGroup::
	; LASS_ATSUKO
	db "ATSUKO@", TRAINERTYPE_ITEM_MOVES
...
FisherGroup::
	; FISHER_HISASHI
	db "HISASHI@", TRAINERTYPE_ITEM_MOVES
...
BeautyGroup::
	; BEAUTY_MEGUMI
	db "MEGUMI@", TRAINERTYPE_ITEM_MOVES
...
SportsmanGroup::
	; SPORTSMAN_SHIGEKI
	db "SHIGEKI@", TRAINERTYPE_ITEM_MOVES
	db  9, DEX_DONPHAN, ITEM_NONE, MOVE_TACKLE, MOVE_DEFENSE_CURL, MOVE_NONE, MOVE_NONE
	db -1 ; end
